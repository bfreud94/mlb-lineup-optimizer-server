...
public class PitcherController {
	...
	public ResponseEntity<String> getPitchers()	{
        List<Pitchers> pitchers = playerDAO.getPitchers();
        System.out.println("Getting pitchers");
        return ResponseEntity.status(HttpStatus.OK).body(gson.toJson(pitchers));
	}
}
